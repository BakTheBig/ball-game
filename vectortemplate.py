...
class PygView(object):
    ...
    def paint(self):
        ...
        x = PygView.width // 2
        y = PygView.height // 2
        pygame.draw.line(self.background, (0,0,1), (x,0), (x, PygView.height), 5)
        pygame.draw.circle(self.background, (0,0,1), (x,y), 300, 5)
        pygame.draw.circle(self.background, (0,0,200), (0,y-300), 600, 1)
        pygame.draw.circle(self.background, (0,0,200), (0,y+300), 600, 1)
        pygame.draw.circle(self.background, (200,0,0), (PygView.width,y-300), 600, 1)
        pygame.draw.circle(self.background, (200,0,0), (PygView.width,y+300), 600, 1) 
            ...
            for c in [self.cannon5,self.cannon6,self.cannon7,self.cannon8]:
                ...
                if len(targetlist)>0:
                    ...
                    if random.random()<0.1:
                        ...
                        Ball(pos=p, move=m.normalized()*150+c.move,mass=10,radius=5, max_distance = c.max_distance, color=c.color)
